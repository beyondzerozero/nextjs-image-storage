...
export default function ImageApp() {
  const public_url =
    "https://xxxxxxxxxxxxx.supabase.co/storage/v1/object/public/public-img-bucket/img/";
  ...
  return (
    <>
      ...
      <div className="w-full max-w-3xl">
        <div className={loadingState} aria-label="읽어오는 중">
